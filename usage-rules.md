...
This file is the prescriptive DO / NEVER contract for working in workspace. Narrative, rationale, and FAQs live in `AGENTS.md` and project technical docs. Each file has one job.

This project uses Intent v2.11.6. See `~/.intent/ext/`, `intent claude skills list`, and `intent claude subagents list` for the full Intent-provided surface.
