...
fn bench_create_entry(c: &mut Criterion) {
    ...
    c.bench_function("datastore/entry/create", |b| {
...
fn bench_get_entry_by_key(c: &mut Criterion) {
    ...
    c.bench_function("datastore/entry/get_by_key", |b| {
        b.to_async(fix.rt).iter(|| async {
            fix.datastore
...
fn bench_get_entries_by_context(c: &mut Criterion) {
    ...
    c.bench_function("datastore/entry/get_by_context", |b| {
        b.to_async(fix.rt).iter(|| async {
            fix.datastore
...
fn bench_delete_entry(c: &mut Criterion) {
    ...
    c.bench_function("datastore/entry/delete", |b| {
        b.iter_batched(
...
fn bench_bulk_write(c: &mut Criterion) {
    ...
    let mut group = c.benchmark_group("datastore/bulk_write");
...
fn bench_bulk_read(c: &mut Criterion) {
    ...
    let mut group = c.benchmark_group("datastore/bulk_read");
    group.measurement_time(Duration::from_secs(30));
