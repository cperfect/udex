...
async fn init_jwt_fixture() -> JwtFixture {
    ...
    // Sign a long-lived JWT with read and write permissions for the test index.
    // lookup-or-create requires both because it reads to check existence and writes when creating.
