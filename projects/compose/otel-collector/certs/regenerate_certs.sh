...
# OTLP TLS certificate generation for the local observability fixture (ST0027).
#
...
#
# The collector is an always-on peer of postgres/hydra in projects/compose; this
# replaces the standalone projects/observability/certs generation from ST0026.
#
