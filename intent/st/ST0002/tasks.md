...
| WP    | Title                                              | Status      |
|-------|----------------------------------------------------|-------------|
| WP-01 | Wire cli crate into workspace                      | Done        |
| WP-02 | clap command skeleton                              | Done        |
| WP-03 | `udex config init` and `udex config validate`      | Done        |
| WP-04 | `udex serve`                                       | Done        |
| WP-05 | gRPC client connection helper                      | Done        |
| WP-06 | `udex index` commands                              | Done        |
| WP-07 | `udex entry` commands                              | Done        |
| WP-08 | `udex token inspect` and `udex context hash`       | Done        |
| WP-09 | Output formatting (`--output table\|json\|yaml`)   | Done        |
